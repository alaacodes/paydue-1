        ...
        <div className="secret">
          <section className="md:w-10/12 w-11/12 md:flex gap-24 justify-start mx-auto pt-24 md:pt-40 pb-24 md:mb-2">
            <aside className="md:w-6/12 w-11/12 mx-auto pt-10">
              ...
              <button className="inline-flex justify-center items-center rounded-md mt-8 py-2 gap-3 px-5 bg-blue-100 text-white text-sm not-italic font-normal leading-6">
                <svg
            ...
            <aside className="md:w-4/12 w-10/12 mx-auto  md:h-[27.5rem] h-[22rem] relative md:mt-0 mt-20 md:mb-0 mb-40">
              ...
              <div className="absolute w-[12rem] bg-[#50505011] backdrop-blur-sm top-[-40px] right-[-3px] z-40 gap-4 inline-flex justify-start items-center px-3 py-2 h-fit shrink-0 rounded-[12.631px]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="27"
                  height="21"
              ...
              {/* //Guy in hat */}
              <div className="absolute guy md:bottom-2 bottom-[-3rem] gap-3 w-[13rem] bg-[#50505012] md:left-[14.25rem] -left-[1.5rem] z-40 inline-flex items-center px-4 py-2 shrink-0 backdrop-blur-sm rounded-[12.631px]">
                <Image
                  priority={true}
                  width={54}
                  height={54}
